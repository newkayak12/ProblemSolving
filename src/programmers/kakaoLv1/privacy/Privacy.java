package programmers.kakaoLv1.privacy;
...
public class Privacy {
    ...
    class TestCase {
        ...
        public void case1 () {
            ...
            StopWatch.start();
            Assertions.assertArrayEquals(expect, solution1(today, terms, privacies));
            StopWatch.end();

            StopWatch.start();
            Assertions.assertArrayEquals(expect, solution2(today, terms, privacies));
            StopWatch.end();
