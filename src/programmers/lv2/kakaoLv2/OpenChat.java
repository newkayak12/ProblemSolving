...
public class OpenChat {
    ...
    public class TestCases {
        ...
        public void case1 () {
            String[] record = {
                    "Enter uid1234 Muzi", // muzi income
                    "Enter uid4567 Prodo", //prodo income
                    "Leave uid1234", //muzi left
                    "Enter uid1234 Prodo", //
                    "Change uid4567 Ryan"
            };
    ...
    public String[] solution(String[] record) {
        ...
        for( String row : record ) {
            String[] log = row.split(" ");
            String action = log[0];
            String id = log[1];


            if( !ActionSet.Leave.key.equals(action) ) {
                String nickname = log[2];
                nicknameTrace.put(id, nickname);
            }
        }
        ...
        for( String row : record ) {
            ...
            if( ActionSet.Change.key.equals(action)) continue;
            result.add(String.format("%s%s", nicknameTrace.get(id), ActionSet.valueOf(action).msg));
        }
