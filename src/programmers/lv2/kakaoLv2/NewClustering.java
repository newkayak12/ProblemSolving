...
public class NewClustering {
    ...
    class TestCases {
        ...
        public void case1 () {
            ...
            Assertions.assertEquals(answer, solution(str1, str2));
        }
        ...
        public void case9 ( ) {
            ...
            List<String> sa1 = format(str1);
            List<String> sb1 = format(str2);

            sa1.retainAll(sb1);
            System.out.println(sa1);

            List<String> sa2 = format(str1);
            List<String> sb2 = format(str2);
    ...
    public int solution(String str1, String str2) {
        List<String> str1List = format(str1);
        List<String> str2List = format(str2);



        return (int) Math.floor (jacquard(str1List, str2List) * 65536);
    }

    private List<String> format(String str) {
        List<String> strings = new ArrayList<>();
        char[] charArray = str.toLowerCase()
                              .toCharArray();
    ...
    private double jacquard(List<String> first, List<String> second) {
        ...
        union.addAll(second);
        for ( String piece : intersection) {
            union.remove(piece);
        }

        if (intersection.isEmpty() && union.isEmpty()) return 1.0;
        else return (intersection.size() * 1.0) / (union.size() * 1.0);
    }
